...
# ============================================================================================================================================
# OMrefB19.3.288 - a 144 model, 288 realization BET OM prepared for the 2019 MSE task force
...
# --- Description --------------------------------------------------------------
MseDef@Name          <- "OMrefB19.3.288"
MseDef@Label         <- "OMrefB19.3.288" #useful for changing graphics labels
MseDef@Date          <- "Jan2019"
MseDef@Author        <- "D.Kolody"
MseDef@Notes         <- "BET reference case OM from OMrefB19.3, fractional factorial screening grid of 144 models "
...
load("objects\\OMgridB19.3.List.RDA")       #the weighted list of BET models
MseDef@OMList       <- as.list(names(OMgridB19.3.List))
...
# --- save object --------------------------------------------------------------
#save(MseDef,file=paste(getwd(),"/Objects/OMd.OMrefB19.3.288.RDA",sep=""))
