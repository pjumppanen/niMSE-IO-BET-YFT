...
# ============================================================================================================================================
# OMrefB19.4.288 - a 288 model, 288 realization BET OM prepared for the 2019 MSE task force
...
# --- Description --------------------------------------------------------------
MseDef@Name          <- "OMrefB19.4.288"
MseDef@Label         <- "OMrefB19.4.288" #useful for changing graphics labels
MseDef@Date          <- "Jan2019"
MseDef@Author        <- "D.Kolody"
MseDef@Notes         <- "BET reference case OM from OMrefB19.4, full factorial grid 288 models "
...
load("objects\\OMgridB19.4.List.RDA")       #the weighted list of BET models
MseDef@OMList       <- as.list(names(OMgridB19.4.List))
