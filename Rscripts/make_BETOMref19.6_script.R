...
source(mainRootDir %&% "OMconditioning\\RStuff\\phase2\\plotIndices2.f.DK.R")
...
OMrefB19.6.List <- rep(1/length(refB19.6.sumStats[[1]][,'modList']), length(refB19.6.sumStats[[1]][,'modList']))
names(OMrefB19.6.List) <- refB19.6.sumStats[[1]][,'modList']
