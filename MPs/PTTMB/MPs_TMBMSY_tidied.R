...
ProjectPTBoB0Targ <- new("BSysProject", WorkingFolder="./MPs/PTTMB/PTBoB0Targ", Debug=FALSE, CXXFLAGS=c("-fno-aggressive-loop-optimizations"))
ProjectPT41F      <- new("BSysProject", WorkingFolder="./MPs/PTTMB/PT41F", Debug=FALSE, CXXFLAGS=c("-fno-aggressive-loop-optimizations"))
