#
# makeGridY20.1.f.R
# create YFT grid Y20.1 = 13 dimensional grid requested by WPTT 2019
...
#***************************************************************************************
# M06, M08, M10 is a placeholder until clarification from AZTI 
#***************************************************************************************
...
makeGridY20.1.f <- function (path='H:\\C-offline\\MSE-IO-BET-YFT\\OMconditioning\\YFT\\', gridName= 'gridY20.1', makeGrid=T, makeBatFiles=T, splitMasterBatch=35, batFile="projBatNoHessJitterLoop")
{
...
deleteMe <- makeGridY20.1.f(path=path, makeBatFiles=F, makeGrid=F)
print(deleteMe)
