...
# modified by Dale Kolody (2019) for IOTC YFT 
...
folder <- "E:\\KOL018\\MSE-IO-BET-YFT\\OMconditioning\\YFT" 
...
model <- "zretro-h80_M06_t10_q0_iH_i1_iR1_gr2_CL75_SD_x4" # quick crash example case
...
model <- "refYFT2018-H0.1"
#SS_doRetro(masterdir=folder, oldsubdir=model, newsubdir=paste0(model,"Retro"), subdirstart="Retro", years=years, extras=ifelse(hessian==TRUE, "-nox", "-nox -nohess"), CallType=call_type)
retro_mods <- SSgetoutput(dirvec=paste0(folder, '\\', model, 'Retro\\Retro', years), getcovar=hessian, ncols=250)


model <- "refYFT2018-H0.2"
#SS_doRetro(masterdir=folder, oldsubdir=model, newsubdir=paste0(model,"Retro"), subdirstart="Retro", years=years, extras=ifelse(hessian==TRUE, "-nox", "-nox -nohess"), CallType=call_type)
retro_mods <- SSgetoutput(dirvec=paste0(folder, '\\', model, 'Retro\\Retro', years), getcovar=hessian, ncols=250)

model <- "refYFT2018-H0.5"
#SS_doRetro(masterdir=folder, oldsubdir=model, newsubdir=paste0(model,"Retro"), subdirstart="Retro", years=years, extras=ifelse(hessian==TRUE, "-nox", "-nox -nohess"), CallType=call_type)
retro_mods <- SSgetoutput(dirvec=paste0(folder, '\\', model, 'Retro\\Retro', years), getcovar=hessian, ncols=250)


model <- "refYFT2018-H-0.1"
#SS_doRetro(masterdir=folder, oldsubdir=model, newsubdir=paste0(model,"Retro"), subdirstart="Retro", years=years, extras=ifelse(hessian==TRUE, "-nox", "-nox -nohess"), CallType=call_type)
retro_mods <- SSgetoutput(dirvec=paste0(folder, '\\', model, 'Retro\\Retro', years), getcovar=hessian, ncols=250)


model <- "refYFT2018-H-0.2"
#SS_doRetro(masterdir=folder, oldsubdir=model, newsubdir=paste0(model,"Retro"), subdirstart="Retro", years=years, extras=ifelse(hessian==TRUE, "-nox", "-nox -nohess"), CallType=call_type)
retro_mods <- SSgetoutput(dirvec=paste0(folder, '\\', model, 'Retro\\Retro', years), getcovar=hessian, ncols=250)

model <- "refYFT2018-H-0.5"
#SS_doRetro(masterdir=folder, oldsubdir=model, newsubdir=paste0(model,"Retro"), subdirstart="Retro", years=years, extras=ifelse(hessian==TRUE, "-nox", "-nox -nohess"), CallType=call_type)
retro_mods <- SSgetoutput(dirvec=paste0(folder, '\\', model, 'Retro\\Retro', years), getcovar=hessian, ncols=250)
