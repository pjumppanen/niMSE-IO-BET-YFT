...
makeGridB19.4.f <- function (path='H:\\C-offline\\MSE-IO-BET-YFT\\OMconditioning\\BET\\', gridName= 'gridB19.4', makeGrid=T, makeBatFiles=T, splitMasterBatch=T, batFile="projBatNoHessJitterLoop")
{
